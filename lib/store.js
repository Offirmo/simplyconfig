...
define([
	...
	'path',
	'callsite',
	'./polyfill/is-path-absolute',
	'./get-set'
],
function(_, path, callsite, is_path_absolute, get_set) {
	'use strict';
	...
	Store.prototype.load = function() {
		if(this.source instanceof Store) {
			...
			switch (this.source) {
				case 'args':
					throw new Error('simplyconfig: loading configuration from args is not implemented');
					break;
				case 'env':
					this._load_from_env();
					break;
